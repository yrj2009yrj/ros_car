...
void GPIO_Configuration(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_10|GPIO_Pin_11;  // 电机方
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;   /*设置引脚模式为通用推挽输出*/
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;     /*设置引脚速率为50MHz */
    GPIO_Init(GPIOC, &GPIO_InitStructure);            /*调用库函数，初始化    PIOC*/
...
//    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;   /*设置引脚模式为通用推挽输出*/
//    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;     /*设置引脚速率为50MHz */
//    GPIO_Init(GPIOE, &GPIO_InitStructure);            /*调用库函数，初始化    PIOC*/
//
